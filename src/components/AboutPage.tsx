    ...
    <div className="min-h-screen">
      ...
      <section className="px-4 md:px-8 lg:px-16 mb-12 md:mb-16 lg:mb-20">
        ...
        <p className="text-sm md:text-base text-white/70 leading-relaxed m-[0px] p-[0px]">
          With a foundation in computer science and a year of hands-on UI/UX experience, I bring a unique blend of technical expertise and design thinking to every project. I started as a Software Development Trainee at Infinity Software Solutions, building real-time features for a Malaysian airline subsidiary, before transitioning to data analysis at NIQ—both roles sharpening my analytical approach to design. I earned my Professional Diploma from the UX Design Institute in 2025 with a 96% final grade. Now, as the sole Product Designer at Spack Solutions in Hyderabad, I manage the complete design process for platforms like Social Synq, One Hub, and more such projects, creating user-friendly experiences across devices for IT, banking, and healthcare sectors. I specialize in Figma, wireframing, usability testing, and user-centered design—always focused on making complex problems simple and meaningful.
        </p>
      </section>
